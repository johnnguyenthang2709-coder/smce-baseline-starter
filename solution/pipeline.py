...
# Active Streamlit-ready implementation.
# The original starter code above is kept for reference, but the public API used
# by Streamlit and scripts is delegated to the cleaner private-round pipeline.
from solution.streamlit_pipeline import predict_from_image, predict_from_text  # noqa: E402,F401
